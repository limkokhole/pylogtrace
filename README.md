...
Sometime we need to know the output log on the screen printed from which file+line of the source code in order to learn and debug a program quickly and accurately. This script show the code stacks tied with the output log with minimized noisiness.
